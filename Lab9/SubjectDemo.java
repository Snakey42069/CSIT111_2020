...
public class SubjectDemo {
	...
	public static void main(String[] args) {
		...
		subject.enrollAllStudents(students);
		...
		for (Student s : subject.getAllStudents()) {
			System.out.println("Student: " + s.getName() + "\tStudent No: " + s.getStudentNumber() + "\tStudent Contact: " + s.getContact());
		}
